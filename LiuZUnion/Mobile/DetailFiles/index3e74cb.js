...
if(!i||!i[0])return!1;
i=i[0],l.isInMiniProgram&&(document.getElementById("js_name")&&a.addClass(document.getElementById("js_name"),"tips_global_primary"),
document.getElementsByClassName("account_nickname_inner")&&a.addClass(document.getElementsByClassName("account_nickname_inner")[0],"tips_global_primary"),
document.getElementById("js_share_author")&&a.addClass(document.getElementById("js_share_author"),"tips_global_primary")),
function(){
...
var A="",I=new Image;
I.src=("http://mp.weixin.qq.com/mp/jsreport?key=4&content=biz:"+biz+",mid:"+mid+",uin:"+uin+"[key4]"+A+"&r="+Math.random()).substr(0,1024);
}
...
var O=-1!=navigator.userAgent.indexOf("TBS/"),T=function(e,o){
t(e,function(e,t){
...
a&&(a.isCDN()&&(a=a.imgChange640(),t&&(a=E.addParam(a,"tp","webp",!0)),a=E.addParam(a,"wxfrom","5",!0),
is_https_res||y?a=a.http2https():("http:"==location.protocol||-1!=navigator.userAgent.indexOf("MicroMessenger"))&&(a=a.https2http())),
setTimeout(function(){
r.onload=function(){
p(r,"height","auto","important"),p(r,"visibility","visible","important");
...
if(t.isCDN()){
o=o.imgChange640();
var n,i=window.navigator.userAgent,r=/TBS\/([\d\.]+)/i,a=i.match(r);
a&&a[1]&&(n=parseInt(a[1]));
...
window.__addIdKeyReport("28307",84)),o=E.addParam(o,"wxfrom","5",!0),is_https_res||y?(o=o.http2https(),
...
try{
if("[object Array]"==Object.prototype.toString.call(t.lazyLoadOnload))for(var n=0,r=t.lazyLoadOnload.length;r>n;n++)"function"==typeof t.lazyLoadOnload[n]&&t.lazyLoadOnload[n].call(t);
}catch(a){}
...
var C=e("appmsg/copyright_report.js");
!function(){
...
for(var a=0,c=o.length;c>a;a++)!function(e){
...
var L=e("appmsg/review_image.js"),W=document.getElementById("js_cover"),P=[];
W&&P.push(W),new L({
container:document.getElementById("js_content"),
...
if(e&&e.className){
for(var t=e.className.split(/\s+/),i=[],r=0,a=t.length;a>r;++r){
var s=t[r];
...
if(a.hasClass(e.target,"js_hotspot")){
...
if(R){
document.title=window.title,a.addClass(i,"not_in_mm");
...
var r=document.getElementById("js_profile_qrcode"),s=document.getElementById("js_profile_arrow_wrp"),d=document.getElementById("profileBt");
if(r&&d&&s){
var c=function(){
...
return r.style.display="block",s.style.left=d.offsetWidth/2-8+"px",!1;
};
g.on(d,"click",c),g.on(r,"click",c),g.on(document,"click",function(e){
var t=e.target||e.srcElement;
t!=d&&t!=r&&(r.style.display="none");
});
}
}else{
...
if(C.card_pv_report(),Math.random()<.01)try{
...
p.parentNode.parentNode.removeChild(p.parentNode),a.removeClass(document.getElementById("js_article"),"preview_appmsg");
});
},1e3),function(){
if(r.os.ios&&"onorientationchange"in window){
...
if(t>=0){
var r=e[t],a=r.ori;
a!==i||e[e.length-1].istouchmove||(n>=11&&17>=n&&window.__report(63),window.scrollTo(0,r.scroll));
}
e.push({
ori:i,
scroll:window.pageYOffset||document.documentElement.scrollTop,
...
var U=Math.random();
if(2e-4>U)try{
for(var G=document.getElementsByTagName("img"),H=window.screen.height,J=window.screen.width,Y=0,V=window.devicePixelRatio,Y="",F=0,X=G.length;X>F;F++){
var $=G[F].getAttribute("data-src");
if($){
var Z=G[F].getBoundingClientRect();
Y+=J+"|"+H+"|"+Z.left.toFixed(2)+"|"+(J-Z.right).toFixed(2)+"|"+Z.width.toFixed(2)+"|"+V.toFixed(2)+"|"+$+";";
}
}
d({
...
var h=window.user_uin||0,A=Math.floor(h/100)%1e3,y=0!==h&&1001>A,v=!0,b="";
